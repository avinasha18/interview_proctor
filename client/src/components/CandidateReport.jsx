      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
          <div className="flex items-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-green-800">Interview Completed Successfully!</h3>
              <p className="text-green-700">Thank you for participating in the interview. Your session has been completed.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-2">Your interview has been completed</p>
            </div>
            <button
              onClick={onBack}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900">{report.interview.candidateName}</p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-500">Interviewer:</span>
                <p className="text-lg font-semibold text-gray-900">{report.interview.interviewerName}</p>
              </div>
              <div>
                <span className="text-sm font-medium text-gray-500">Interview Duration:</span>
                <p className="text-lg font-semibold text-gray-900">{report.interview.duration || 0} minutes</p>
              </div>
            </div>
            <div className="space-y-3">
              <div>
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-gray-900 font-mono">{report.interview.sessionId}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Integrity Score */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Integrity Score</h2>
          <div className="text-center">
            ...
            <p className="text-lg font-medium text-gray-700">out of 100</p>
        ...
        {/* Event Breakdown */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Event Breakdown</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <p className="text-gray-600 mb-4">Download detailed reports in different formats</p>
